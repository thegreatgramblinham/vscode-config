...
code --uninstall-extension alefragnani.bookmarks >> code --uninstall-extension ms-dotnettools.csharp >> code --uninstall-extension naumovs.color-highlight >> code --uninstall-extension ferrierbenjamin.fold-unfold-all-icone >> code --uninstall-extension dimitarnonov.jellybeans-theme >> code --uninstall-extension alefragnani.project-manager >> code --uninstall-extension efbenson.scad >> code --uninstall-extension wayou.vscode-todo-highlight >> code --uninstall-extension shardulm94.trailing-spaces >> code --uninstall-extension vscode-icons-team.vscode-icons >> code --uninstall-extension dotjoshjohnson.xml
ECHO == ALL DONE!
PAUSE